        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="index.php" aria-current="page" class="<?php if ($_SERVER['REQUEST_URI'] === '/laracast-websites/demo/index.php' ) { echo 'bg-black 900 text-white'; } else {echo 'text-gray-300';} ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Rhodé's Homepage</a>
